...
const string strMessageMagic = "Lizus Signed Message:\n";
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv)
{
	...
	if (strCommand == "version")
	{
		...
		if (pfrom->nVersion < MIN_PEER_PROTO_VERSION || (nBestHeight >= 160000 && pfrom->nVersion < MIN_PEER_PROTO_VERSION_WAIT) || (nBestHeight >= 170000 && pfrom->nVersion < MIN_PEER_PROTO_VERSION_FORCE))
		{
