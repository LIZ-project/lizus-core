#include "addeditlizusnode.h"
#include "ui_addeditlizusnode.h"
...
AddEditLizusNode::AddEditLizusNode(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::AddEditLizusNode)
{
    ui->setupUi(this);
    ...
    ui->txhashLineEdit->setPlaceholderText("Enter your 500 LIZ TXID");
...
AddEditLizusNode::~AddEditLizusNode()
{
    delete ui;
}


void AddEditLizusNode::on_okButton_clicked()
{
    ...
    {
        QMessageBox msg;
        msg.setText("Please enter an ip address and port. (123.45.67.89:19700)");
        msg.exec();
        return;
    }
...
void AddEditLizusNode::on_cancelButton_clicked()
{
    reject();
}

void AddEditLizusNode::on_AddEditAddressPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
    ui->addressLineEdit->setText(QApplication::clipboard()->text());
}

void AddEditLizusNode::on_AddEditPrivkeyPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
    ui->privkeyLineEdit->setText(QApplication::clipboard()->text());
}

void AddEditLizusNode::on_AddEditTxhashPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
