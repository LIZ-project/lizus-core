...
private slots:
    ...
    QString BuyLIZ(QString OrderType, double Quantity, double Rate);
    QString SellLIZ(QString OrderType, double Quantity, double Rate);
