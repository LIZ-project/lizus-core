...
int nAnonymizeLizusAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Lizus
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Lizus
    // Mac: ~/Library/Application Support/Lizus
    // Unix: ~/.lizus
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Lizus";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "lizus.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "lizusd.pid"));
